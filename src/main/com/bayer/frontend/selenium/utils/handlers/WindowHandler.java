...
public class WindowHandler extends BaseHandler {
	...
	public void switchToParentWindow(String parentWindow, String... waitFor) {
		switchToWindow(parentWindow, waitFor);
	}
	...
	public WebDriver switchToMainFrame(String... waitFor) {
		try {
	...
	public WebDriver switchToFrame(WebElement element, String... waitFor) {
		try {
	...
	public WebDriver switchToFrame(String idOrName, String... waitFor) {
		try {
	...
	public WebDriver waitForFrameAndSwitchIt(int index, String... waitFor) {
		try {
	...
	public WebDriver waitForFrameAndSwitchIt(String idOrName, String... waitFor) {
		try {
			WebDriverWait wait = new WebDriverWait(driver, PropertiesRepository.getInt("global.driver.wait"));
	...
	public WebDriver waitForFrameAndSwitchIt(WebElement element, String... waitFor) {
		try {
			WebDriverWait wait = new WebDriverWait(driver, PropertiesRepository.getInt("global.driver.wait"));
